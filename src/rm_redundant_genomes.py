...
def cal_genome_divergence(param):
    ...
    fa1, fa2,max_local_divergence,maxCO = param
    ...
    # min_oh = 5, replaced with maxCO, maximum overhang len for contained contigs
    # max_local_divergence = 0.001 #pacbio clr
    # max_local_divergence = 0.01 #for test, maybe for ont TODO
    if fa1_oh <= maxCO and local_divergence < max_local_divergence:
        contained = 1  # fa1 is contained contig
    elif fa2_oh <= maxCO and local_divergence < max_local_divergence:
        contained = 2
...
if __name__ == '__main__':
    fa_list_file, max_global_divergence, outdir, threads,max_local_divergence,maxCO = sys.argv[1:]
    ...
    # print(final_fastas)
    div_out = []
    params = [(fa1, fa2,max_local_divergence,maxCO) for fa1, fa2 in combinations(fa_list, 2)]
